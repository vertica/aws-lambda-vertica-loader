...
Our github repo - ["AWS-Lambda-Vertica-Loader"](https://github.com/vertica/aws-lambda-vertica-loader) - was cloned from the AWS repo. The code and documentation for this Vertica loader, including some of the text and diagrams used here, is very much a derivitive work. *Thank you, AWS!*
